...
public class PlayerTest {
    ...
    /*
    @Test
    void testSetPotionsSol() {
        try {
            Player player1 = new Player("player1", new Status(4, 1, 2, 2));

            Potion potion1 = new Potion("Potion11", 12,new Status(5, 2, 3, 5));
            Potion potion2 = new Potion("Potion22",8, new Status(4, 2, 1, 8));

            Potion potion11 = new Potion("Potion11", 12,new Status(5, 2, 3, 5));
            Potion potion22 = new Potion("Potion22", 8,new Status(4, 2, 1, 8));
